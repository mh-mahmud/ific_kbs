<template>
    <div class="main-wrapper d-flex">
        ...
        <div class="main-content-wrapper w-100 position-relative overflow-auto bg-white" >
            ...
            <div class="content-area" >
                <div class="content-title-wrapper px-15 py-10">
                    <h2 class="content-title text-uppercase m-0">Link List</h2>
                </div>
                                    ...
                                    <v-container class="p-0 position-relative overflow-hidden">
                                        ...
                                        <v-row>
                                            <v-col class="customer-data-table-wrapper">
                                                <v-data-table :headers="headers" :items="linkList" :search="search" :hide-default-footer=true  class="elevation-1" :items-per-page="20">
                                                    ...
                                                    <template v-slot:item.actions="{item}">
                                                        ...
                                                        <button class="btn btn-success ripple-btn right-side-common-form btn-xs mx-1"
                                                                @click="link_id=item.id, isEditCheck=true" v-if="checkPermission('category-edit')">
                                                            <i class="fas fa-pen"></i>
                                                        </button>
                                                        <button  class="btn btn-danger ripple-btn right-side-common-form btn-xs mx-1"
                                                                 @click="link_id=item.id, isDeleteCheck=true" v-if="checkPermission('category-delete')">
        ...
        <div class="right-sidebar-wrapper with-upper-shape fixed-top px-20 pb-30 pb-md-40 pt-70">
            ...
            <!--            add data-->
            <LinkAdd v-if="isAddCheck" :isAddCheck="isAddCheck" @link-slide-close="getAddDataFromChild"></LinkAdd>
            <!--            edit data-->
            <LinkEdit v-if="isEditCheck" :isEditCheck="isEditCheck" :linkId="link_id" @link-slide-close="getEditDataFromChild"></LinkEdit>
            <!--            delete data -->
    ...
    export default {
        ...
        methods: {
            ...
            getLinkList(pageUrl)
            {
                ...
                pageUrl = pageUrl == undefined ? 'links' : pageUrl;
                    ...
                    }).then(function (response)
                {
                    ...
                    {   
                        ...
                        _that.pagination.current = response.data.link_list.current_page;
                        _that.pagination.total   = response.data.link_list.last_page;
                        _that.linkList           = response.data.link_list.data;
