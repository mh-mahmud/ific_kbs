...
<div>
  <textarea  :id="idFromParent" class="form-control summernote" cols="30" rows="6"></textarea>
</div>
        ...
        $.ajax({
          ...
          success: function(data) {
            ...
            if(data.status_code == 200) {
              ...
              if(vm.idFromParent == 'bn_Body') {

                $('#bn_Body.summernote').summernote("insertNode", image[0]);

              } else {

                $('#en_Body.summernote').summernote("insertNode", image[0]);
